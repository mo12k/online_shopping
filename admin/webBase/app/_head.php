...
<div class="sidebar">
    <ul>
        ...
        <a href="/page/customer.php" >Customer List</a>
        </li>

        <li class="<?= $current == 'product' ? 'active' : '' ?>">
        <a href="/page/product.php">Product List</a>
        </li>

        <li class="<?= $current == 'order' ? 'active' : '' ?>">
        <a href="/page/order.php">Order List</a>
        </li>

        <li class="<?= $current == 'staff' ? 'active' : '' ?>">
        <a href="/page/staff.php">Staff List</a>
        </li>
    </ul>
</div>
